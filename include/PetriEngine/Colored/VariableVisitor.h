...
namespace PetriEngine {
    namespace Colored {
        ...
        class VariableVisitor : public ColorExpressionVisitor {
            ...
            std::unordered_map<uint32_t, std::vector<const Colored::Variable*>>& _tuples;
        ...
        public:
            VariableVisitor(std::set<const Colored::Variable*>& variables, PositionVariableMap& varPositions,
                    VariableModifierMap& varModifierMap, std::unordered_map<uint32_t, std::vector<const Colored::Variable*>>& _tuples, bool includeSubtracts)
            ...
            virtual void accept(const VariableExpression* e)
            {
                ...
                if(_tupleIndex > 0){
                    _tuples[_tupleIndex].emplace_back(e->variable());
                }
            ...
            static inline void get_variables(Expression& e, std::set<const Colored::Variable*>& variables, PositionVariableMap& varPositions, VariableModifierMap& varModifierMap, std::unordered_map<uint32_t, std::vector<const Colored::Variable*>>& tuples, bool includeSubtracts) {
            ...
            static inline void get_variables(Expression& e, std::set<const Colored::Variable*>& variables, std::unordered_map<uint32_t, std::vector<const Colored::Variable*>>& tuples) {
                PositionVariableMap varPositions;
                VariableModifierMap varModifierMap;
